...
public class ManageChatRoom {
	public static ManageChatRoom instance;

	private Set<ChatRoom> chatRooms; 
	private Set<ChatUser> chatUsers; 

	private ManageChatRoom(){
		chatRooms = new HashSet<ChatRoom>();
		chatUsers = new HashSet<ChatUser>();
	}

	public static ManageChatRoom getInstance(){
		if(instance == null){
			instance = new ManageChatRoom();
		}
		return instance;		
	}

	public ChatRoom getChatData(String chatRoomName, Socket clientSocket){
		...
		System.out.println("New chat room created is "+chatRoomName);

		// or else create a new room, 
	...
	public void handleChatInRoom(String inputLine, Socket clientSocket){
		...
		// get chat room of login user and socket
		if(typingUser != null){
